...
export default function LikedJobsScreen() {
  ...
  const sortedJobs = [...state.likedJobs].sort((a, b) => {
    switch (sortBy) {
      case "salary":
  ...
  const renderHeader = () => (
    <View style={styles.header}>
      <Text style={[styles.title, { color: colors.text }]}>
        {t("chooseList")} ({state.likedJobs.length})
      </Text>
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={[styles.emptySubtext, { color: colors.tabIconDefault }]}>
        {t("swipeRight")} to add jobs to your list
      </Text>
    </View>
  );
